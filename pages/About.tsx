...
export const About: React.FC = () => {
   return (
      <div className="min-h-screen bg-white">
         ...
         <section className="relative pt-24 pb-12 md:pt-48 md:pb-32 overflow-hidden">
            ...
            <div className="container mx-auto px-6 md:px-12 relative z-10">
               <div className="max-w-4xl animate-fade-in-up">
                  ...
                  <h1 className="text-4xl md:text-7xl font-bold text-neutral-900 mb-6 md:mb-8 leading-[0.95] tracking-tight">
                     About <br />
            ...
            <div className="container mx-auto px-6 md:px-12">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                     ...
                     <div key={i} className="bg-neutral-50 p-5 md:p-8 rounded-2xl border border-neutral-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                        <div className={`w-12 h-12 md:w-14 md:h-14 ${val.color} rounded-xl flex items-center justify-center mb-4 md:mb-6`}>
                           <val.icon size={24} />
                        </div>
                        <h3 className="text-lg md:text-xl font-bold text-neutral-900 mb-2 md:mb-3">{val.title}</h3>
                        <p className="text-sm md:text-base text-neutral-500 leading-relaxed">{val.desc}</p>
                     </div>
                  ))}
               </div>
            </div>
         ...
         {/* Vision Section */}
         <section className="py-12 md:py-24 bg-neutral-900 text-white relative overflow-hidden">
            {/* Abstract BG */}
         ...
         <section className="py-12 md:py-24 bg-white">
            <div className="container mx-auto px-6 md:px-12">
               ...
               {/* CTA */}
               <div className="mt-8 md:mt-12 text-center flex flex-col sm:flex-row gap-3 justify-center">
                  <Link to="/shop">
                     <Button size="md" className="w-full sm:w-auto md:px-8 md:py-4 md:text-lg">Shop Now</Button>
                  </Link>
                  <Link to="/corporate">
                     <Button variant="outline" size="md" className="w-full sm:w-auto md:px-8 md:py-4 md:text-lg">Wholesale Inquiry</Button>
                  </Link>
               </div>
            </div>
         </section>
